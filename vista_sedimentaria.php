...
<div class="container-fluid p-3">
    ...
    <h1 class="display-6 text-center p-3 text-warning">Rocas Sedimentarias</h1>

    <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php
            $sql = $conexion->query("SELECT * FROM rocas WHERE clasederoca LIKE '%sedimentaria%'");
...
<div class="container">
    ...
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <p class="text-center text-body-secondary">&copy; 2023 Humberto</p>
    </footer>
</div>
